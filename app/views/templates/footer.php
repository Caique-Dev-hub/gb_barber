        ...
        <div class="footer">
            <div class="box">
                ...
                <ul style="width: 380px; height: 200px;text-align: center;">
                    ...
                    <li style="margin-bottom: 10px;"><a href="">SERVIÇO</a></li>
                    <li style="margin-bottom: 10px;"><a href="">SOBRE</a></li>
                    <li style=""><a href="">CONTATO</a></li>
                </ul>
            </div>
            <div class="box">
                <h3>Contato</h3>
                <ul style="font-size: 1.8rem; text-align: center;" class="local">
                    ...
                    <li>(11) 95853-8834</li>
                    <li>contato@gbbarber.com</li>
                </ul>
            </div>
            <div class="share">
                <h3>Nos Siga</h3>
                <div style="text-align: center;">
                    <img style="height: 40px; width: 40px; color: #fff;"
